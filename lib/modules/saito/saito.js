...
console.log("\n\n\nSAITO REGISTRY: "+conf+"\n\n");
console.log(tx);
  // register the email address on the zero confirmation
  // 
...
console.log("6");
            ...
            console.log(sql);
            params = { $identifier : tx.transaction.msg.saito_identifier, $publickey : tx.transaction.from[0].add, $unixtime : tx.transaction.ts };
            console.log(params);

            app.storage.execDatabase(sql, params, function() {
            console.log("Success in hitting db");
console.log("7");
              ...
              server_email_html = 'Saito Email Address Registered<p></p>You can now receive emails from anyone running the default Saito client by giving them this address:<p></p>'+tx.transaction.msg.saito_identifier+'@saito.tech<p></p>Thanks for trying Saito!';
...
////////////////////////////////////////////////
// Save and Retrieve PKs from Saito Addresses //
////////////////////////////////////////////////
Saito.prototype.returnAddress = function returnPublicKey(app, identifier) {
