...
Twitter.prototype.formatTransaction = function formatTransaction(tx, app) {
  ...
  tx.transaction.msg.tweet  = $('#tweet_reply_input').val();
...
console.log("ATTACHING MSG TO INBOX: ");
console.log(msg);
...
Twitter.prototype.initializeHTML = function initializeHTML(app) {
  ...
  for (yii = 0; yii < app.options.messages.length; yii++) {
    ...
    if (txtx.transaction.msg.module == "Twitter") {
...
console.log("\n\nLOADING FRIENDS: ");
console.log(app.options.friends);
