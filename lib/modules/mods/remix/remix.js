...
Remix.prototype.webServer = function webServer(app, expressapp) {
  ...
  expressapp.post('/remix/submit', function (req, res) {
    ...
    var htmllink       = '<html><body>We have compiled your application into a Saito module.<p></p>Click on one of the following links to test it:<p></p><a href="/remix/cache/html/'+unique_ht+'">Saito email application</a><p></p><a href="/remix/cache/html/'+unique_no+'-app.html">Saito web application</a><p></p>To test your module on the live network, just share the URL of these pages.</body></html>';
