	...
	email_self.resetEmailForm();
	  ...
	  afterShow : function() {
	    ...
	    $('#restore_privatekey_submit').on('click', function() {
	      ...
	      var pubkey = email_self.app.crypt.returnPublicKey(privkey);
...
console.log(answer);
		  ...
		  email_self.app.wallet.wallet.utxi = [];
		  email_self.app.wallet.wallet.utxo = [];
		  email_self.app.wallet.wallet.privateKey = privkey;
		  email_self.app.wallet.wallet.publicKey  = pubkey;

          	  email_self.app.options.blockchain.lastblock = 0;
          	  email_self.app.storage.saveOptions();
          	  email_self.app.wallet.saveWallet();
