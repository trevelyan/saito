...
//////////////////////////
Email.prototype.addMessageToInbox = function addMessageToInbox(tx, app, use_markdown=1) {
    ...
    this.attachMessage(msg, app, use_markdown);
...
';
    email_self.addMessageToInbox(tmptx, app, 0);
...
Email.prototype.attachMessage = function attachMessage(message, app, use_markdown=1) {
                            ...
                            <table style="border:0px"> \
                              <tr class="inner_message" id="message_'+message.id+'"> \
                               <td class="from">'+this.formatAuthor(message.from, app)+'</td> \
                                ...
                                <td class="data" style="display:none">'+md+'</td> \
                              </tr> \
                            </table> \
                          </td> \
                        </tr>';
