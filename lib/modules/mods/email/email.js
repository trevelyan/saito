...
console.log("FETCHING PUBLICKEY: ");
		  ...
		  app.dns.fetchRecordFromAppropriateServer(to, function(answer, publickey="") {

console.log("FETCHING PUBLICKEY2: " + answer + " -- " + publickey);
		    ...
		    email_self.app.keys.addKey(mypublickey, to, 0);
...
Email.prototype.attachEmailEvents = function attachEmailEvents() {
  ...
  if (this.app.BROWSER == 1) {
    ...
    $('.register_email_address_success').on('click', function() {
      $.fancybox.close();
      email_self.app.dns.fetchIdFromAppropriateServer(email_self.app.wallet.returnPublicKey(), function (answer, publickey="") {
