...
var msg = tx.transaction.msg.requested_identifier;
  console.log("IN REGISTRY: " + tx.transaction.msg.requested_identifier);
//  console.log(app.crypt.hash(msg.toString('hex'), 'hex'));
  console.log(Buffer.from(msg, 'utf-8'));
  console.log(Buffer.from(msg, 'utf-8').toString('base64'));
