...
function Registry(app) {
  ...
  this.publickey       = "03b010291b430796d0016e1a2e756b1860a6d0456c659baec7ceb71b9b495a89e3"; // hardcoded
  return this;
  ...
  if (conf == 0) {
    ...
    if (tx.transaction.msg != null) {
      ...
      app.storage.queryDatabase(tmsql, params, function(err, row) {
	    ...
	    var sqlwrite = "INSERT OR IGNORE INTO mod_registry_addresses (identifier, publickey, unixtime, signature) VALUES ('"+full_identifier+"','"+publickey+"',"+unixtime+", '"+registrysig+"');";
	    fs.writeFileSync((__dirname + "/web/addresses.txt"), sqlwrite, function(err) {
	      if (err) {
