...
console.log(thistx);
      ...
      remote_address = thistx.transaction.to[0].add;
...
console.log(bob_secret.toString("hex"));
      ...
      email_html = 'Your request for encrypted communications has been accepted from: <p></p>'+app.modules.returnModule("Email").formatAuthor(remote_address, app)+'<p></p>Your future correspondence will be encrypted with a shared-secret only known to your two accounts.';
