...
Encrypt.prototype.displayEmailForm = function displayEmailForm(app) {
  ...
  element_to_edit.html('<div style="min-height:100px;padding:40px;font-size:1.2em;">Saito will automatically encrypt your communications with peer nodes and email recipients if you have exchanged secret keys. This requires the use of Diffie-Hellman key exchange to create a shared secret. To start encrypting mssages, please enter the private key or email address of the account you wish to communicate with securely as the receiver to this message. Clicking submit will initiate a key-exchange request. Once the recipient authorizes the request, you will automatically be able to communicate with them securely.</div>');
...
console.log("CONFIRMING KEY EXCHANGE (as alice, recreated): ");
console.log("Bp:  "+bob_publickey.toString("hex"));
console.log("Ap:  "+alice_publickey.toString("hex"));
console.log("Ar:  "+alice_privatekey.toString("hex"));
console.log("A2p: "+alice2_publickey.toString("hex"));
console.log("A2r: "+alice2_privatekey.toString("hex"));
console.log("SS:  "+alice_secret.toString("hex"));
