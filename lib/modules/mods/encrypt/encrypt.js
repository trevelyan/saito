...
Encrypt.prototype.displayEmailForm = function displayEmailForm(app) {
  ...
  element_to_edit.html('<div style="min-height:100px;padding-top:120px;padding:40px;font-size:1.6em;line-height:2.4em;">To encrypt email you need to create a shared secret using the Diffie-Hellman key-exchange method. Provide the address of the person with whom you wish to communicate securely and click send to initiate a key-exchange securely across the Saito blockchain. You will be notified when the receiver approves your request, and all subsequent email between you will be automatically encrypted.</div>');
}
