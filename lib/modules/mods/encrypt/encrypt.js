...
Encrypt.prototype.displayEmailForm = function displayEmailForm(app) {
  ...
  element_to_edit.html('<div style="min-height:100px;padding-top:120px;padding:40px;font-size:1.6em;line-height:2.4em;">Provide the address of the person with whom you wish to communicate securely and click send to initiate a Diffie-Hellman key-exchange with them across the Saito blockchain. You will be notified when they approve your request, and subsequent email with them will be automatically encrypted.</div>');
}
