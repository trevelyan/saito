...
Debug.prototype.displayEmailForm = function displayEmailForm(app) {
  ...
  element_to_edit.html('<div style="min-height:100px;padding-top:120px;padding:40px;font-size:1.15em;line-height:1.2em;"><pre><code></code>'+JSON.stringify(app.blockchain.index, null, 4)+'</pre></div>');
