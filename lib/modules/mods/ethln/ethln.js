...
alert("You are idx: " + this.account_idx);
...
alert(payment + " -- " + ethln_self.accounts[ethln_self.account_idx].current_coin_distribution + " -- " + ethln_self.account_idx);
