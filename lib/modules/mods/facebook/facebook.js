...
console.log("RECEIVED FACEBOOK TX: ");
console.log(tx);
...
console.log("WE COMMENTED -- SAVING PARENT POST");
console.log("Archives? " + app.archives.containsMessageById(tx.transaction.msg.post_id));
