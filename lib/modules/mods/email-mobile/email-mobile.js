...
Email.prototype.displayEmailForm = function displayEmailForm(app) {
  ...
  element_to_edit_css  = '<style>.email{width:100%;height:408px;padding:4px;} .email_title{margin-top:15px;width:100%;padding:5px;font-size:0.9em;} .email_body { width:100%;height:395px;font-size:0.9em;padding:5px; } </style>';
