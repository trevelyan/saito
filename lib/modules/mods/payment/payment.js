...
<h2>Purchase Saito Tokens:</h2> \
<p></p> \
To purchase Saito tokens, please <a href="/payment?saito_buyer='+app.wallet.returnPublicKey()+'&saito_identifier='+app.wallet.returnIdentifier()+'">click here</a>. \
</div> \
<style> \
';
	  ...
	  if (row != null) {
	    if (row.count > 0) {
	      ...
	      newtx.transaction.msg.module = "Email";
              newtx.transaction.msg.data  = "Your purchase of Saito tokens has been processed by the network";
...
\
  ...
  if (this.app.wallet.returnBalance() <= (this.saito_amount + this.saito_fee)) {
    ...
    pagehtml += ' \
      <h2>Purchase Saito tokens using Ethereum (ETH):</h2> \
      \
      <p></p> \
      We need your Saito address and the Ethereum address that will make payment. \
      \
      <p></p> \
      \
      <form action="/payment/ethereum" method="get"> \
      <table><tr><td class="table_label"> \
        <label for="saito_buyer">Your Saito Address:</label> \
      </td><td class="table_input"> \
        <input type="text" name="saito_buyer" value="' + saito_buyer +'" /> \
      </td></tr><tr><td class="table_label"> \
        <label for="ethereum_buyer">Your Ethereum Address:</label> \
      </td><td class="table_input"> \
