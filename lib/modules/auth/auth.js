...
/////////////////////////////
Auth.prototype.displayUserInputForm = function displayUserInputForm(app) {

  element_to_edit = $('#module_editable_space');
  element_to_edit.html('<div style="min-height:100px;padding:40px;font-size:1.2em;">\
If your application requires one, you can provide an extra keyword and/or key/value pair. \
 \
<p></p> \
 \
...
<p></p> \
 \
<div style="margin-top:20px;font-weight:normal;cursor:pointer;margin-bottom:25px;" onclick="$(\'.advanced_keyvalue_entry\').toggle();">Click here for advanced options...</div> \
<div class="advanced_keyvalue_entry" style="display:none"> \
<table> \
...
/////////////////////////////////
//
// this is a special function that hooks into our HTML email client
// it allows messages sent-and-received by the email function to 
// contain links that can interact with these third-party modules.
//
// in this case, we attach an event in our email that sends an
// authorization confirmation to the sender if we decide that we
// want to do this.
//
Auth.prototype.attachEmailEvents = function attachEmailEvents(app) {
  ...
  if (app.BROWSERIFY == 1) {
    ...
    $('.authorize_link').on('click', function() {
	  ...
	  app.modules.returnModule("Email").sendBrowserAlert("your authorization has been broadcast to the network");
...
<p></p>\
\
To authorize this account, <span onclick="function() { \
\
alert("authorizing account");\
\
}" style="text-decoration:underline;cursor:pointer">click here</span>.';
