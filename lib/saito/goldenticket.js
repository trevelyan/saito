...
console.log("\nOur prev_treasury is: "+prev_treasury+"   and we are adding the reclaimed funds of: "+prev_reclaimed);
...
console.log((prev_treasury+prev_reclaimed));
console.log(this.solution.miner_share + " --- " + this.solution.node_share);

  var mp = [];
  mp[0]  = prev_treasury;
  mp[1]  = prev_coinbase;

console.log("Returning MP: ");
console.log(JSON.stringify(mp, null, 4));
