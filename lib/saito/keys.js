...
// this can also be used to add identifiers and tags to existing keys
// it can upgrade keys to "watched" status but not downgrade existing
// watched keys.
...
console.log("Added key with pk: "+publickey);
  this.saveKeys();
...
console.log("ADDING KEY: "+publickey);
