...
console.log("DNS: ");
console.log(this.app.options.dns);
...
console.log("s: "+this.dns.domains[s].publickey);

    for (var t = 0; t < this.app.network.peers.length; t++) {

console.log("t: "+this.app.network.peers[t].peer.host + " -- " + this.app.network.peers[t].peer.publickey);
