...
Wallet.prototype.getAdequateInputs = function getAdequateInputs(amount_needed) {
  ...
  for (i = 0; i < this.wallet.utxi.length; i++) {
    ...
    value = parseFloat(this.wallet.utxi[i].returnAmount()) + parseFloat(value);;
...
console.log("REMOVING PAYMENT INPUT 1");
console.log("WE FOUND THIS SLIP: ");
console.log(this_slip);
console.log("THESE ARE THE ONES WE HAVE: " + this.wallet.utxi.length);
...
console.log("REMOVING PAYMENT INPUT 2");
