...
Wallet.prototype.initialize = function initialize() {
  ...
  if (this.wallet.privateKey == "") {
	...
	if (this.app.BROWSER == 1) {
          ...
          tmp_privatekey = this.app.options.wallet.privateKey;
          tmp_publickey  = this.app.options.wallet.publicKey;
          tmp_identifier = this.app.options.wallet.identifier;
	  ...
	  // uncomment this if we want to reset the blockchain
  	  //this.app.options.blockchain.lastblock = 0;
  ...
  tmp_genesis_id = this.app.blockchain.returnGenesisBlockId();
...
console.log("ADDING SLIP: "+this_slip.bid + " -- " + this_slip.tid + " -- " + this_slip.sid);
...
console.log("REMOVING SLIP 1: "+this_slip.bid + " -- " + this_slip.tid + " -- " + this_slip.sid);
        if (
	  ...
	  // remove input
console.log("REMOVING SLIP 2: "+this_slip.bid + " -- " + this_slip.tid + " -- " + this_slip.sid);
          if (this.containsUtxo(this_slip) == 0) {
console.log("REMOVING SLIP 3: "+this_slip.bid + " -- " + this_slip.tid + " -- " + this_slip.sid);
	    this.wallet.utxo.push(this.wallet.utxi[sc]);
          }
	  this.wallet.utxi.splice(sc, 1);
console.log("REMOVING SLIP 4: "+this_slip.bid + " -- " + this_slip.tid + " -- " + this_slip.sid);
