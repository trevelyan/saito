...
/******** BUG HUNTING
	  // we do not permit nodes to create blocks for money unless they are on a private network and/or
          // have no connections to the outside world. If the network runs out of money for some reason, a 
	  // node can pull away, generate a few blocks and rebroadcast those blocks on rejoining the network
