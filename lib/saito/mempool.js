...
//console.log("G: "+parseFloat(fees_available) + " -- " + parseFloat(fees_needed));
//console.log("H: "+mempool_self.returnNormalTransactionsInMempool() + " -- " + mempool_self.app.wallet.returnBalance() + " -- " + mempool_self.app.blockchain.index.hash.length);
...
console.log(JSON.stringify(mempool_self.app.network.returnNetwork(), null, 4));
console.log("aa");
              return;
            } else {
...
console.log("c -- " + mempool_self.containsGoldenTicket());
