...
Server.prototype.initialize = function initialize() {
  ...
  // web resources //
  ///////////////////
  app.get('/index.html.gz', function (req, res) {
    res.header('Content-Type', 'text/html');
    res.header('Content-Encoding', 'gzip');
    res.sendFile(__dirname + '/web/index.html.gz');
    return;
  });
  app.get('/browser.js.gz', function (req, res) {
  ...
  console.log("SERVER ADDRESS: "+ webserver.address().address );
