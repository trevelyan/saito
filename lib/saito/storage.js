...
console.log("HERE WE ARE: " + myblk.returnId());
...
console.log("BLOCKS TO VALIDATE SEQUENTIALLY: "+blocks_to_validate_sequentially);
...
console.log("BLOCKS TO RUN: "+rows.length);
      if (rows.length == 0) {
