...
Storage.prototype.validateLongestChain = function validateLongestChain(newblock, shared_ancestor_index_pos, new_block_idxs, new_block_hashes, old_block_hashes, old_block_idxs) {
...
****/
  ...
  // for now, just directly call the function that will follow
  this.app.blockchain.addBlockToBlockchainPartTwo(newblock);
