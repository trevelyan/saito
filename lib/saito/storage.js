...
Storage.prototype.saveOptions = function saveOptions() {
  ...
  this.app.options.wallet  = this.app.wallet.returnJson();
  this.app.options.network = this.app.network.returnJson();
  this.app.options.server  = this.app.server.returnJson();
...
console.log("saving client options");
  ...
  tmpjson.messages = {};
  tmpjson.modules  = {};
  tmpjson.peers    = this.app.server.returnJson();
  tmpjson.wallet   = new saito.wallet().returnJson();
