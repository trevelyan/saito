...
Browser.prototype.updateBalance = function updateBalance() {
  ...
  for (md = 0; md < this.app.modules.mods.length; md++) {
    this.app.modules.mods[md].updateBalance(this.app);
  }
}
