...
Browser.prototype.attachEvents = function attachEvents() {
      ...
      $('#lightbox_compose_module_select').on('change', function() {
        ...
        browser_self.app.modules.displayUserInputForm(modsel);
      });
        ...
        $.fancybox({
          ...
          afterShow : function(){
           ...
           $('#send').on('click', function() {
             ...
             newtx = browser_self.app.wallet.createUnsignedTransactionWithFee(to, amount, fee);
             modsel = $('#lightbox_compose_module_select').val();
             ...
             browser_self.showBrowserAlert("your message has been broadcast to the network");
      ...
      $('.inner_message').on('click', function() {
        ...
        $.fancybox({
          ...
          afterShow : function(){
            ...
            browser_self.app.modules.attachMessageEvents(message_id, module);
...
Browser.prototype.updateBalance = function updateBalance() {
    ...
    if (this.app.BROWSERIFY == 0) { return; } 
    // update wallet balance
    $('#balance_money').html(this.app.wallet.returnBalance());

}

Browser.prototype.showBrowserAlert = function showBrowserAlert(message="your message has been broadcast to the network") {
