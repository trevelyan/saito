...
console.log(message);
    ...
    if (message.request == "connect-reply") {
      ...
      var server_guesstimated_last_shared_id = peer_self.app.blockchain.returnLastSharedBlockId(their_fork_id, their_last_block_id);
      if (server_guesstimated_last_shared_id < their_last_block_id) { their_last_block_id = server_guesstimated_last_shared_id; }
