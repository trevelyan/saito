...
console.log(message.data);
      peer_self.sendBlockchain(message.data.block_id);
      return;
    }
...
console.log("Sending Request for Blocks");
  this.sendRequest(response.request, response.data);
console.log("Done sending request for blocks");
...
//
Peer.prototype.sendBlockchain = function sendBlockchain(starting_block_id) {
