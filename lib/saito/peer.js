...
Peer.prototype.startQueueTimer = function startQueueTimer() {

  console.log("\n\nSTARTING QUEUE TIMER: " + this.peer.speed + " - " + this.peer.speed);
...
Peer.prototype.sendQueuedRequest = function sendQueuedRequest() {
  ...
  if (this.message_queue.length > 0) {
    ...
    if (this.socket != null) {
      if (this.socket.connected == true) {
x = new Date().getTime();
console.log("... sending queued request ... " + + " --- " + this.message_queue.length);
