...
//console.log("CONNECTING SECTION");
...
console.log("SENDING PAYMENT TO: "+peer_self.peer.publickey);
...
console.log("CONNECTING REPLY SECTION");
      // save options
    ...
    if (message.request == "golden ticket") {
      tx = new saito.transaction(message.data);
      peer_self.app.blockchain.mempool.addTransaction(tx);
      return;
    }
...
console.log("CONNCTING TO PEER 2");
