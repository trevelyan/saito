...
console.log("LCHAIN LEN: "+lchain_len);
console.log(formerchain);
...
console.log("setting LongestChain status to 1 for: "+blk.app.blockchain.index.block_id[formerchain[fcl]]);
  }
