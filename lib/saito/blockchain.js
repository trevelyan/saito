...
function Blockchain(app) {
  ...
  this.currently_indexing      = 0;         // we processing a block?
...
console.log("CURRENTLY INDEXING SOMETHING!");
 return 2; }
  this.currently_indexing = 1;

  console.log("Adding "+newblock.hash()+ " -- " + newblock.block.unixtime + " / " + newblock.block.miner);
