...
function Blockchain(app) {
  ...
  this.hashmap = []; 		     // hashmap index is the  block hash and contains 
  ...
  this.block_saving_timer_speed = 30;
  ...
  this.max_heartbeat           = 5;         // burn fee hits zero every 120 seconds
...
//console.log(" ... save block");
  ...
  // HASH MAP //
  //////////////
  this.hashmap[hash] = i_am_the_longest_chain;
...
console.log(" ... commit done: " + tmpDateTime);
...
Blockchain.prototype.successfulBlockTransactionValidation = function successfulBlockTransactionValidation(app, tx=null, blk, forceAdd, validationIncrement = 1) {
  app.blockchain.validate_current += validationIncrement;
