...
console.log(" ... and validating inputs");
      this.app.storage.validateTransactionInputsOnBlockchainIndexAndStore(newblock, nbhasharr, existing_longestChain, 2, validate_transactions, forceAdd);
    }
  }
