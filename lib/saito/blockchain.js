...
console.log("OLD CHAIN TO: " + old_longestChain);
...
console.log("old longesetchain: " + old_longestChain);
console.log("Am I the longest chain: " + i_am_the_longest_chain);
console.log("new hash hunt: " + new_hash_to_hunt_for);
console.log("old hash hunt: " + old_hash_to_hunt_for);
console.log(JSON.stringify(this.index.hash));
...
console.log("VALIDATE LONG CHAIN BEFORE: ");
...
Blockchain.prototype.addBlockToBlockchainFailure = function addBlockToBlockchainFailure(newblock, pos, i_am_the_longest_chain, forceAdd, old_lc) {
  ...
  console.log("\n\n\nFAILURE IN ADDING BLOCK TO BLOCKCHAIN: resetting....");

  // restore longest chain
  this.index.lc[this.longestChain] = 0;
  this.index.lc_hashmap[newblock.returnHash()] = 0;
...
Blockchain.prototype.addBlockToBlockchainPartTwo = function addBlockToBlockchainPartTwo(newblock, pos, i_am_the_longest_chain, forceAdd) {
  ...
  //no need as is new block
  //blockchain_self.app.storage.onChainReorganization(newblock.block.id, newblock.returnHash(), 1);
  //blockchain_self.app.wallet.onChainReorganization(newblock.block.id, newblock.returnHash(), 1);
  //blockchain_self.app.modules.onChainReorganization(newblock.block.id, newblock.returnHash(), 1);
...
console.log("BALANCE: ");
console.log(blockchain_self.app.wallet.returnBalance());
