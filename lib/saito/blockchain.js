...
console.log(JSON.stringify(this.index.hash));
    ...
    this.app.storage.validateLongestChain(newblock, pos, shared_ancestor_index_pos, new_block_idxs, new_block_hashes, old_block_hashes, old_block_idxs, i_am_the_longest_chain, forceAdd);
...
// wallet, etc. 
//
// if the block that was provided is not on the longest chain, we will 
// still hit this function.
//
