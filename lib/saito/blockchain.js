...
console.log(" ... track the longest chain");
  ...
  // if first block
//console.log(newblock.returnId() + " - " + this.returnLatestBlockId() + " %%%%%% " + this.app.options.blockchain.lastblock + " !!!!! " + this.index.hash.length);
  try {
  if (this.app.options.blockchain.latest_block_id != null) {
  if (this.index.hash.length == 1 && this.app.options.blockchain.latest_block_id == newblock.returnId()-1) {
console.log("This seems to be my first block ever in a new sync....");
    this.longestChain = 0;
    i_am_the_longest_chain = 1;
  }
  }
...
console.log("DID WE ADD TX: "+updated_wallet + " - " + i_am_the_longest_chain);
  if (updated_wallet == 1) {
console.log("DID WE ADD TX: "+updated_wallet + " - " + i_am_the_longest_chain);
    if (i_am_the_longest_chain == 1) {
console.log("DID WE ADD TX: "+updated_wallet + " - " + i_am_the_longest_chain);
...
console.log("DID WE ADD TX: "+this.app.wallet.returnBalance());
    }
    this.app.storage.saveOptions();
  }
