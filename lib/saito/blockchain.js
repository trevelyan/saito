...
// AT THIS POINT WE DO NOT KNOW IF OUR BLOCKS ARE LONGEST -- lets CHECK SLIP DATA
console.log("PRE-SLIP CHECK FOR NEW BLOCK");
...
console.log("\n\ninserting a block and identifying the longest chain...");
