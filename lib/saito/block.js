...
function Block(app, blkjson="", conf=-1) {
  ...
  this.confirmations                 = conf;     // number of confirmations
						 // we have a shortcut when blocks are set from database
						 // we just tell our constructor to set confs to whatever
						 // they were when we saved them
...
Block.prototype.updateConfirmationNumberWithoutCallback = function updateConfirmationNumberWithoutCallback(confnum) {
