...
console.log("HERE: " + blkjson);
    for (var i = 0; i < this.block.transactions.length; i++) {
console.log(" inserting ... " + this.block.transactions.length + " " + i )
...
console.log("ADDING DECRYPTED MESSAGE CALLBACK FOR 1: ");
console.log(JSON.stringify(this.transactions[z].decrypted_msg));
    if (this.transactions[z].decrypted_msg.module != undefined) {
//console.log("ADDING DECRYPTED MESSAGE CALLBACK FOR 2: ");
//console.log(this.transactions[z].decrypted_msg);
      this.app.modules.affixCallbacks(z, this.transactions[z].decrypted_msg, this.callbacks, this.callbacksTx, this.app);
    } else {
