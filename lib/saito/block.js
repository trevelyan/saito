...
console.log("\n\nCreating Block CODE: \n");
  ...
  if (prevblock != null) {
    ...
    this.block.treasury = prevblock.block.treasury - miner_share - node_share + prevblock.block.reclaimed;
    this.block.coinbase = (this.block.treasury / this.app.blockchain.genesis_period).toFixed(8);

console.log("\n\nBLOCK CREATION T/C SET TO: "+this.block.treasury + " -- " + this.block.coinbase);
...
console.log("CREATING BLOCK AND SETTING RECLAIMED: "+reclaimed);
    block_self.block.reclaimed = reclaimed;
console.log("\n\nRECLAIMED FUNDS: "+block_self.block.reclaimed);
...
console.log("7");
    ...
    console.log("I am creating block #"+this.block.id+" and calculating the funds not-spent from block "+eliminated_block);
...
console.log("TOTAL UNSPENT in slips: "+total_amount_to_add_to_treasury);
...
console.log(params2);
		...
		console.log("\n\nSOLVED GOLDEN TICKET: no money to recycle back from gts");
...
console.log("TOTAL UNSPENT in golden tickets: "+lost_golden_ticket);

		    total_amount_to_add_to_treasury = parseFloat(total_amount_to_add_to_treasury)+parseFloat(lost_golden_ticket);
	          }

console.log("TOTAL AMOUNT TO RECLAIM: "+total_amount_to_add_to_treasury);
                  mycallback(total_amount_to_add_to_treasury);
		  return;
...
console.log("H: "+this.returnTreasury() + " -- " + this.returnCoinbase());
...
console.log("RECLAIMED comparison: "+block_self.block.reclaimed + " -- " + reclaimed);
