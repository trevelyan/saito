...
Block.prototype.debugHTML = function debugHTML() {
  ...
  html  = '<table>';
  html += '<tr><td>Block Id</td><td>'+this.block.id+'</td></tr>';
  html += '<tr><td>Block Hash</td><td>'+this.hash('hex')+'</td></tr>';
  html += '<tr><td>Unixtime</td><td>'+this.block.unixtime+'</td></tr>';
  html += '<tr><td>Previous Block Hash</td><td>'+this.block.prevhash+'</td></tr>';
  html += '<tr><td>Miner</td><td>'+this.block.miner+'</td></tr>';
