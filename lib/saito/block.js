...
console.log("checking tx pubkeys: "+this.transactions[rd].transaction.msg);
console.log("checking tx pubkeys: "+publickey);
...
Block.prototype.validate = function validate() {
  ...
  // our mempool and in indexAndStore() on block addition.
  var ft_found = 0;
...
console.log(" ... affixing callbacks: "+ this.transactions.length);
  for (var z = 0; z < this.transactions.length; z++) {
