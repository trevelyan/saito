...
console.log("Now that we have created our objects, lets test app manipulation");

app.blockchain.app.BROWSERIFY = 423;

console.log(app.blockchain.app.BROWSERIFY);
console.log(app.storage.app.BROWSERIFY);
